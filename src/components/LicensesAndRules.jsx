...
export default function LicensesAndRules (){
    return (
        <div className="rules-page">
            ...
            <section className="rules-section">
                <div className="rules-section-heading">
                    ...
                    <BookmarkButton id="rules-getting-started" label="Getting started with a license" to="/LicensesAndRules#getting-started" size="sm" className="rules-bookmark"/>
                </div>
                <p>
            ...
            <section className="rules-section">
                <div className="rules-section-heading">
                    ...
                    <BookmarkButton id="rules-license-types" label="License types overview" to="/LicensesAndRules#license-types" size="sm" className="rules-bookmark"/>
                </div>
                <p>
                    Wisconsin offers several license types that cater to what fish you want to catch and how long you plan to fish. There are resident and nonresident licenses and several options for different situations. 
                ...
                <p>Other licenses cover the special situations in the fishing system. This includes discounted or modified licenses for disabled residents, veterans, and senior anglers as well 
                    ...
                    can also buy a one day or short term licenses which are cheaper and gererally only cover a single day. </p>
            </section>
            ...
            <section className="rules-section">
                <div className="rules-section-heading">
                    ...
                    <BookmarkButton id="rules-seasons" label="Season overview" to="/LicensesAndRules#seasons" size="sm" className="rules-bookmark"/>
                </div>
                <div className="rules-license-row">
                ...
                <table className="rules-table">
                    ...
                    <tbody>
                        ...
                        <tr><td>Lake Sturgeon (Winnebago system spearing)</td><td>Feb. 8 - Feb. 23</td></tr>
            ...
            <section className="rules-section">
                <div className="rules-section-heading">
                    ...
                    <BookmarkButton id="rules-bag-limits" label="Bag & size limits" to="/LicensesAndRules#bag-limits" size="sm" className="rules-bookmark"/>
                </div>
                <p>
            ...
            <section className="rules-section">
                <div className="rules-section-heading">
                    ...
                    <BookmarkButton id="rules-methods" label="Methods & line limits" to="/LicensesAndRules#methods" size="sm" className="rules-bookmark"/>
                </div>
                <p>
            ...
            <section className="rules-section">
                <div className="rules-section-heading">
                    ...
                    <BookmarkButton id="rules-safety" label="Safety & ethics" to="/LicensesAndRules#safety" size="sm" className="rules-bookmark"/>
                </div>
                <p>
